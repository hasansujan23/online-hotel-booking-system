...
//        String id=request.getParameter("idTextBox");
            String customerId=request.getAttribute("custId").toString();
            String paymentId=request.getParameter("paymentIdTextBox");
            session.setAttribute("paymentTextBox", paymentId);
            %>
            ...
            <div id="register">
                ...
                <input id="textInput" type="text" name="cidTextBox" value="<%=customerId%>"><br><br>
